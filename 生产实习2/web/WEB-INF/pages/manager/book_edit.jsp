...
<body>
		...
		<div id="main">
			<form action="<%=basePath%>manager/updateBook" method="post" enctype="multipart/form-data">
				<table>
					<tr>
						<td>
							名称
						...
						<td rowspan="2" style="text-align: left">原始图片</td>
						<td rowspan="2"><img class="book_img" alt="" src="<%=basePath%>${book.img_path}" width="50px" height="50px" /></td>
					</tr>
					<tr>
						<td>价格</td>
